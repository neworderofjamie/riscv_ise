...
plot_var_grid(hidden_v, np.load("hidden_v.npy"), 9, "V", 8, 8)
plot_var_grid(hidden_a, np.load("hidden_a.npy"), 8, "A", 8, 8)
plot_var_grid(output_v_sum, np.load("out_v_sum.npy"), 10, "VSum", 5, 4)
