...
primary_input_output = LinearWithSTDP(primary_input.out_spikes, output.i, "s9_6_sat_t", syn_thresh=32, syn_inc_without_spike=1,syn_dec_without_spike=1, syn_inc_with_spike=1,syn_dec_with_spike=1, name="primary_input_output")
