...
struct Token
{
    enum class Type
    {
        ...
        LESS, LESS_EQUAL,
        AT, EQUAL, STAR_EQUAL, SLASH_EQUAL, PERCENT_EQUAL, PLUS_EQUAL,
    ...
    Token(Type type, std::string_view lexeme, size_t line, size_t index,
          std::optional<CompilerFrontend::Type::ResolvedType> numberType = std::nullopt)
    ...
    size_t line;
    size_t index;
    std::optional<CompilerFrontend::Type::ResolvedType> numberType;
};
}   // namespace CompilerFrontend
