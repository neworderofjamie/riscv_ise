...
//----------------------------------------------------------------------------
// CompilerFrontend::Type::FunctionFlags
//----------------------------------------------------------------------------
namespace CompilerFrontend::Type
{
...
//----------------------------------------------------------------------------
// CompilerFrontend::Type::NumericValue
//----------------------------------------------------------------------------
...
class COMPILER_FRONTEND_EXPORT NumericValue
{
public:
...
//----------------------------------------------------------------------------
// CompilerFrontend::Type::ResolvedType
//----------------------------------------------------------------------------
struct COMPILER_FRONTEND_EXPORT ResolvedType
{
    //------------------------------------------------------------------------
    // Numeric
    //------------------------------------------------------------------------
...
//----------------------------------------------------------------------------
struct COMPILER_FRONTEND_EXPORT UnresolvedType
{
...
COMPILER_FRONTEND_EXPORT ResolvedType getPromotedType(const ResolvedType &type);

//! Apply C rules to get common type between numeric types a and b
COMPILER_FRONTEND_EXPORT ResolvedType getCommonType(const ResolvedType &a, const ResolvedType &b, bool reverseFixedPoint = false);

//! Write numeric value to string, formatting correctly for type
COMPILER_FRONTEND_EXPORT std::string writeNumeric(const NumericValue &value, const ResolvedType &type);

//! Serialise numeric value to bytes
COMPILER_FRONTEND_EXPORT void serialiseNumeric(const NumericValue &value, const ResolvedType &type, std::vector<std::byte> &bytes);

//----------------------------------------------------------------------------
// updateHash overrides
//----------------------------------------------------------------------------
COMPILER_FRONTEND_EXPORT void updateHash(const NumericValue &v, boost::uuids::detail::sha1 &hash);
COMPILER_FRONTEND_EXPORT void updateHash(const ResolvedType::Numeric &v, boost::uuids::detail::sha1 &hash);
COMPILER_FRONTEND_EXPORT void updateHash(const ResolvedType::Value &v, boost::uuids::detail::sha1 &hash);
COMPILER_FRONTEND_EXPORT void updateHash(const ResolvedType::Pointer &v, boost::uuids::detail::sha1 &hash);
COMPILER_FRONTEND_EXPORT void updateHash(const ResolvedType::Function &v, boost::uuids::detail::sha1 &hash);
COMPILER_FRONTEND_EXPORT void updateHash(const ResolvedType &v, boost::uuids::detail::sha1 &hash);
COMPILER_FRONTEND_EXPORT void updateHash(const UnresolvedType &v, boost::uuids::detail::sha1 &hash);
}   // namespace CompilerFrontend::Type
