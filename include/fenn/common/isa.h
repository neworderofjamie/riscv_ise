...
BETTER_ENUM(OpType, uint32_t, ADD, SUB, SLL, SLT, SLTU, XOR, SRL, SRA, OR, AND, 
            MUL, MAX, MAXU, MIN, MINU, SH1ADD, SH2ADD, SH3ADD, INVALID)
BETTER_ENUM(SystemType, uint32_t, ECALL, EBREAK, CSRRW, CSRRWI, CSRRS, 
            CSRRSI, CSRRC, CSRRCI, INVALID)

BETTER_ENUM(VOpType, uint32_t, VADD, VSUB, VAND, VSLL, VSRA, VMUL, VMUL_RS, VMUL_RN, INVALID)
...
BETTER_ENUM(VSpcType, uint32_t, VRNG, VANDADD, INVALID)
...
FENN_COMMON_EXPORT LoadType getLoadType(uint32_t funct3);

FENN_COMMON_EXPORT StoreType getStoreType(uint32_t funct3);

FENN_COMMON_EXPORT BranchType getBranchType(uint32_t funct3);

FENN_COMMON_EXPORT OpImmType getOpImmType(int32_t imm, uint32_t funct3);

FENN_COMMON_EXPORT OpType getOpType(int32_t funct7, uint32_t funct3);

FENN_COMMON_EXPORT SystemType getSystemType(int32_t imm, uint32_t funct3);

FENN_COMMON_EXPORT VOpType getVOpType(uint32_t funct7, uint32_t funct3);

FENN_COMMON_EXPORT VOpImmType getVOpImmType(int32_t imm, uint32_t funct3);

FENN_COMMON_EXPORT VTstType getVTstType(uint32_t funct3);

FENN_COMMON_EXPORT VMovType getVMovType(uint32_t funct3);

FENN_COMMON_EXPORT std::tuple<VLoadType, bool> getVLoadType(uint32_t funct3);

FENN_COMMON_EXPORT std::tuple<VStoreType, bool> getVStoreType(uint32_t funct3);

FENN_COMMON_EXPORT VSpcType getVSpcType(uint32_t funct3);
