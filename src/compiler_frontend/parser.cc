...
using namespace CompilerFrontend::Parser;
...
const std::map<std::multiset<std::string>, Type::ResolvedType> numericTypeSpecifiers{
    ...
    {{"signed", "short", "fract", "sat"}, Type::S0_15Sat},
    {{"short", "fract", "sat"}, Type::S0_15Sat},
    {{"signed", "short", "accum", "sat"}, Type::S8_7Sat},
    {{"short", "accum", "sat"}, Type::S8_7Sat},

    {{"s0_15_t"}, Type::S0_15},
    {{"s0_15_sat_t"}, Type::S0_15Sat},
    {{"s1_14_t"}, Type::S1_14},
    {{"s1_14_sat_t"}, Type::S1_14Sat},
    {{"s2_13_t"}, Type::S2_13},
    {{"s2_13_sat_t"}, Type::S2_13Sat},
    {{"s3_12_t"}, Type::S3_12},
    {{"s3_12_sat_t"}, Type::S3_12Sat},
    {{"s4_11_t"}, Type::S4_11},
    {{"s4_11_sat_t"}, Type::S4_11Sat},
    {{"s5_10_t"}, Type::S5_10},
    {{"s5_10_sat_t"}, Type::S5_10Sat},
    {{"s6_9_t"}, Type::S6_9},
    {{"s6_9_sat_t"}, Type::S6_9Sat},
    {{"s7_8_t"}, Type::S7_8},
    {{"s7_8_sat_t"}, Type::S7_8Sat},
    {{"s8_7_t"}, Type::S8_7},
    {{"s8_7_sat_t"}, Type::S8_7Sat},
    {{"s9_6_t"}, Type::S9_6},
    {{"s9_6_sat_t"}, Type::S9_6Sat},
    {{"s10_5_t"}, Type::S10_5},
    {{"s10_5_sat_t"}, Type::S10_5Sat},
    {{"s11_4_t"}, Type::S11_4},
    {{"s11_4_sat_t"}, Type::S11_4Sat},
    {{"s12_3_t"}, Type::S12_3},
    {{"s12_3_sat_t"}, Type::S12_3Sat},
    {{"s13_2_t"}, Type::S13_2},
    {{"s13_2_sat_t"}, Type::S13_2Sat},
    {{"s14_1_t"}, Type::S14_1},
    {{"s14_1_sat_t"}, Type::S14_1Sat},
...
Type::ResolvedType parseDeclarationSpecifiers(ParserState &parserState)
{
