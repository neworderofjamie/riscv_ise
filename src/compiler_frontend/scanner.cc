...
using namespace CompilerFrontend::Scanner;
...
const std::unordered_map<std::string_view, Token::Type> keywords{
    ...
    {"s0_15_sat_t", Token::Type::TYPE_SPECIFIER},
    {"s1_14_t", Token::Type::TYPE_SPECIFIER},
    {"s1_14_sat_t", Token::Type::TYPE_SPECIFIER},
    {"s2_13_t", Token::Type::TYPE_SPECIFIER},
    {"s2_13_sat_t", Token::Type::TYPE_SPECIFIER},
    {"s3_12_t", Token::Type::TYPE_SPECIFIER},
    {"s3_12_sat_t", Token::Type::TYPE_SPECIFIER},
    {"s4_11_t", Token::Type::TYPE_SPECIFIER},
    {"s4_11_sat_t", Token::Type::TYPE_SPECIFIER},
    {"s5_10_t", Token::Type::TYPE_SPECIFIER},
    {"s5_10_sat_t", Token::Type::TYPE_SPECIFIER},
    {"s6_9_t", Token::Type::TYPE_SPECIFIER},
    {"s6_9_sat_t", Token::Type::TYPE_SPECIFIER},
    {"s7_8_t", Token::Type::TYPE_SPECIFIER},
    {"s7_8_sat_t", Token::Type::TYPE_SPECIFIER},
    {"s8_7_t", Token::Type::TYPE_SPECIFIER},
    {"s8_7_sat_t", Token::Type::TYPE_SPECIFIER},
    {"s9_6_t", Token::Type::TYPE_SPECIFIER},
    {"s9_6_sat_t", Token::Type::TYPE_SPECIFIER},
    {"s10_5_t", Token::Type::TYPE_SPECIFIER},
    {"s10_5_sat_t", Token::Type::TYPE_SPECIFIER},
    {"s11_4_t", Token::Type::TYPE_SPECIFIER},
    {"s11_4_sat_t", Token::Type::TYPE_SPECIFIER},
    {"s12_3_t", Token::Type::TYPE_SPECIFIER},
    {"s12_3_sat_t", Token::Type::TYPE_SPECIFIER},
    {"s13_2_t", Token::Type::TYPE_SPECIFIER},
    {"s13_2_sat_t", Token::Type::TYPE_SPECIFIER},
    {"s14_1_t", Token::Type::TYPE_SPECIFIER},
    {"s14_1_sat_t", Token::Type::TYPE_SPECIFIER},
