...
const std::map<CompilerFrontend::Type::ResolvedType, CompilerFrontend::Type::ResolvedType> unsignedType{
    {CompilerFrontend::Type::Int8, CompilerFrontend::Type::Uint8},
    {CompilerFrontend::Type::Int16, CompilerFrontend::Type::Uint16},
    {CompilerFrontend::Type::Int32, CompilerFrontend::Type::Uint32}};
}   // Anonymous namespace
    ...
    return std::visit(
         Utils::Overload{
             ...
             [](const std::string &name)
             {
                ...
                if (errorHandler.hasError()) {
                    throw std::runtime_error("Error parsing numeric type '" + name + "'");
                }
                return resolvedType;
             }},
        detail);
