...
std::optional<uint32_t> RISCV::readCSR(uint32_t csr, bool willWrite) const
{
    ...
    IMPLEMENT_READ_ROUTER_REG(SLAVE_SWAP_BUFFER)
    IMPLEMENT_READ_ROUTER_REG(SLAVE_EVENT_START_ADDRESS)
    IMPLEMENT_READ_ROUTER_REG(SLAVE_EVENT_END_ADDRESS)
...
bool RISCV::writeCSR(uint32_t csr, uint32_t val)
{
    ...
    IMPLEMENT_WRITE_ROUTER_REG(SLAVE_SWAP_BUFFER)
