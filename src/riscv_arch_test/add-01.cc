...
// ArchTest::add_01
//----------------------------------------------------------------------------
const std::vector<uint32_t> &ArchTest::add_01::getScalarInitData()
{
    return g_ScalarData;
}
//----------------------------------------------------------------------------
std::vector<uint32_t> ArchTest::add_01::generateCode(bool simulate)
{
    CodeGenerator c;
    ...
    c.li(Reg::X7, MASK_XLEN(-0x801));
    c.li(Reg::X9, MASK_XLEN(-0x4001));
    c.add(Reg::X5, Reg::X7, Reg::X9);
    c.sw(Reg::X5, Reg::X10, 0);
    ...
    c.li(Reg::X12, MASK_XLEN(-0x40001));
    c.li(Reg::X3, MASK_XLEN(0x7fffffff));
    c.add(Reg::X12, Reg::X12, Reg::X3);
    c.sw(Reg::X12, Reg::X10, 4);
    ...
    c.li(Reg::X6, MASK_XLEN(-0x400001));
    c.li(Reg::X1, MASK_XLEN(-0x40000001));
    c.add(Reg::X1, Reg::X6, Reg::X1);
    c.sw(Reg::X1, Reg::X10, 8);
    ...
    c.li(Reg::X2, MASK_XLEN(0x20));
    c.li(Reg::X2, MASK_XLEN(0x20));
    c.add(Reg::X7, Reg::X2, Reg::X2);
    c.sw(Reg::X7, Reg::X10, 12);
    ...
    c.li(Reg::X0, MASK_XLEN(0x0));
    c.add(Reg::X0, Reg::X0, Reg::X0);
    c.sw(Reg::X0, Reg::X10, 16);
    ...
    c.add(Reg::X14, Reg::X8, Reg::X4);
    c.sw(Reg::X14, Reg::X10, 20);
    ...
    c.li(Reg::X13, MASK_XLEN(-0x11));
    c.li(Reg::X6, MASK_XLEN(-0x800001));
    c.add(Reg::X9, Reg::X13, Reg::X6);
    c.sw(Reg::X9, Reg::X4, 8);

    // rs1==x15, rs2==x14, rd==x13, rs2_val == -4194305, rs1_val == -5
    // opcode: add ; op1:x15; op2:x14; dest:x13; op1val:-0x5;  op2val:-0x400001
    c.li(Reg::X15, MASK_XLEN(-0x5));
    c.li(Reg::X14, MASK_XLEN(-0x400001));
    c.add(Reg::X13, Reg::X15, Reg::X14);
    c.sw(Reg::X13, Reg::X4, 12);
    ...
    c.li(Reg::X13, MASK_XLEN(-0x80001));
    c.add(Reg::X10, Reg::X1, Reg::X13);
    ...
    c.li(Reg::X7, MASK_XLEN(-0x20001));
    c.add(Reg::X8, Reg::X9, Reg::X7);
    c.sw(Reg::X8, Reg::X1, 4);
