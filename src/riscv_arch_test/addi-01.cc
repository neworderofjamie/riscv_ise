...
// ArchTest::addi_01
//----------------------------------------------------------------------------
const std::vector<uint32_t> &ArchTest::addi_01::getScalarInitData()
{
    return g_ScalarData;
}
//----------------------------------------------------------------------------
std::vector<uint32_t> ArchTest::addi_01::generateCode(bool simulate)
{
    CodeGenerator c;
    ...
    c.li(Reg::X6, MASK_XLEN(0x20000000));
    c.addi(Reg::X5, Reg::X6, SEXT_IMM(-0x800));
    ...
    c.addi(Reg::X10, Reg::X10, SEXT_IMM(0x667));
    ...
    c.li(Reg::X14, MASK_XLEN(-0x40000001));
    c.addi(Reg::X0, Reg::X14, SEXT_IMM(0x40));
    ...
    c.addi(Reg::X11, Reg::X2, SEXT_IMM(0x556));
    ...
    c.addi(Reg::X6, Reg::X15, SEXT_IMM(-0x11));
    c.sw(Reg::X6, Reg::X4, 16);

    // rs1==x13, rd==x1, rs1_val == -134217729, 
    // opcode: addi ; op1:x13; dest:x1; op1val:-0x8000001;  immval:-0x4
    c.li(Reg::X13, MASK_XLEN(-0x8000001));
    c.addi(Reg::X1, Reg::X13, SEXT_IMM(-0x4));
    c.sw(Reg::X1, Reg::X4, 20);
    ...
    c.addi(Reg::X2, Reg::X4, SEXT_IMM(-0xa));
    c.sw(Reg::X2, Reg::X5, 16);

    // rs1==x8, rd==x9, rs1_val == -262145, imm_val == -513
    // opcode: addi ; op1:x8; dest:x9; op1val:-0x40001;  immval:-0x201
    c.li(Reg::X8, MASK_XLEN(-0x40001));
    c.addi(Reg::X9, Reg::X8, SEXT_IMM(-0x201));
    c.sw(Reg::X9, Reg::X5, 20);

    // rs1==x9, rd==x12, rs1_val == -131073, 
    // opcode: addi ; op1:x9; dest:x12; op1val:-0x20001;  immval:0x3
    c.li(Reg::X9, MASK_XLEN(-0x20001));
    c.addi(Reg::X12, Reg::X9, SEXT_IMM(0x3));
    c.sw(Reg::X12, Reg::X5, 24);
    ...
    c.addi(Reg::X11, Reg::X10, SEXT_IMM(0x7ff));
    ...
    c.addi(Reg::X11, Reg::X10, SEXT_IMM(-0x401));
    ...
    c.addi(Reg::X11, Reg::X10, SEXT_IMM(0x3ff));
    ...
    c.addi(Reg::X11, Reg::X10, SEXT_IMM(0x1));
