...
//----------------------------------------------------------------------------
std::vector<uint32_t> ArchTest::and_01::generateCode(bool simulate)
{
    CodeGenerator c;
    ...
    c.li(Reg::X3, MASK_XLEN(0x8));
    c.and_(Reg::X10, Reg::X11, Reg::X3);
    ...
    c.li(Reg::X13, MASK_XLEN(0x3));
    c.li(Reg::X11, MASK_XLEN(0x7fffffff));
    c.and_(Reg::X13, Reg::X13, Reg::X11);
    ...
    c.and_(Reg::X6, Reg::X12, Reg::X6);
    c.sw(Reg::X6, Reg::X1, 8);
    ...
    c.li(Reg::X8, MASK_XLEN(0x40000));
    c.li(Reg::X8, MASK_XLEN(0x40000));
    c.and_(Reg::X5, Reg::X8, Reg::X8);
    c.sw(Reg::X5, Reg::X1, 12);
    ...
    c.li(Reg::X4, MASK_XLEN(0x100000));
    c.li(Reg::X4, MASK_XLEN(0x100000));
    c.and_(Reg::X4, Reg::X4, Reg::X4);
    c.sw(Reg::X4, Reg::X1, 16);
    ...
    c.li(Reg::X15, MASK_XLEN(-0x4000001));
    c.li(Reg::X2, MASK_XLEN(-0x8000001));
    c.and_(Reg::X12, Reg::X15, Reg::X2);
    ...
    c.li(Reg::X15, MASK_XLEN(-0x4000001));
    c.and_(Reg::X8, Reg::X6, Reg::X15);
    c.sw(Reg::X8, Reg::X1, 24);
    ...
    c.li(Reg::X5, MASK_XLEN(-0x2000001));
    c.and_(Reg::X9, Reg::X10, Reg::X5);
    c.sw(Reg::X9, Reg::X1, 28);

    c.li(Reg::X4, 52);
    // rs1==x2, rs2==x0, rd==x1, rs2_val == -16777217, 
    // opcode: and ; op1:x2; op2:x0; dest:x1; op1val:0x40000;  op2val:0x0
    c.li(Reg::X2, MASK_XLEN(0x40000));
    c.li(Reg::X0, MASK_XLEN(0x0));
    c.and_(Reg::X1, Reg::X2, Reg::X0);
    c.sw(Reg::X1, Reg::X4, 0);
    ...
    c.li(Reg::X7, MASK_XLEN(0x1000000));
    c.li(Reg::X10, MASK_XLEN(-0x400001));
    c.and_(Reg::X2, Reg::X7, Reg::X10);
    c.sw(Reg::X2, Reg::X4, 8);

    // rs1==x1, rs2==x9, rd==x14, rs2_val == -2097153, rs1_val == -16385
    // opcode: and ; op1:x1; op2:x9; dest:x14; op1val:-0x4001;  op2val:-0x200001
    c.li(Reg::X1, MASK_XLEN(-0x4001));
    c.li(Reg::X9, MASK_XLEN(-0x200001));
    c.and_(Reg::X14, Reg::X1, Reg::X9);
    ...
    c.li(Reg::X14, MASK_XLEN(-0x401));
    c.li(Reg::X13, MASK_XLEN(-0x100001));
    c.and_(Reg::X7, Reg::X14, Reg::X13);
    ...
    c.li(Reg::X3, MASK_XLEN(-0x3));
    c.li(Reg::X14, MASK_XLEN(-0x80001));
    c.and_(Reg::X0, Reg::X3, Reg::X14);
    ...
    c.li(Reg::X9, MASK_XLEN(0x2000000));
    c.li(Reg::X7, MASK_XLEN(-0x40001));
    c.and_(Reg::X11, Reg::X9, Reg::X7);
    ...
    c.and_(Reg::X3, Reg::X0, Reg::X12);
    c.sw(Reg::X3, Reg::X4, 28);
