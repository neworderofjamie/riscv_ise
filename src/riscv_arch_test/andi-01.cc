...
std::vector<uint32_t> ArchTest::andi_01::generateCode(bool simulate)
{
    ...
    c.andi(Reg::X11, Reg::X14, SEXT_IMM(-0x800));
    ...
    c.andi(Reg::X2, Reg::X2, SEXT_IMM(0x2c));
    ...
    c.andi(Reg::X5, Reg::X10, SEXT_IMM(0x4));
    ...
    c.andi(Reg::X14, Reg::X9, SEXT_IMM(0x7));
    c.sw(Reg::X14, Reg::X1, 12);

    // rs1==x12, rd==x3, rs1_val == -268435457, imm_val == 64
    // opcode: andi ; op1:x12; dest:x3; op1val:-0x10000001;  immval:0x40
    c.li(Reg::X12, MASK_XLEN(-0x10000001));
    c.andi(Reg::X3, Reg::X12, SEXT_IMM(0x40));
    c.sw(Reg::X3, Reg::X1, 16);
    ...
    c.andi(Reg::X0, Reg::X15, SEXT_IMM(0x2));
    ...
    c.andi(Reg::X12, Reg::X11, SEXT_IMM(0x7ff));
    ...
    c.andi(Reg::X13, Reg::X0, SEXT_IMM(0x555));
    c.sw(Reg::X13, Reg::X2, 28);
    ...
    c.andi(Reg::X11, Reg::X10, SEXT_IMM(0x20));
    ...
    c.andi(Reg::X11, Reg::X10, SEXT_IMM(0x400));
    ...
    c.andi(Reg::X11, Reg::X10, SEXT_IMM(0x100));
