...
std::vector<uint32_t> ArchTest::or_01::generateCode(bool simulate)
{
    ...
    c.li(Reg::X3, MASK_XLEN(0x20000000));
    c.or_(Reg::X2, Reg::X10, Reg::X3);
    ...
    c.or_(Reg::X14, Reg::X14, Reg::X10);
    c.sw(Reg::X14, Reg::X5, 4);
    ...
    c.or_(Reg::X6, Reg::X1, Reg::X6);
    c.sw(Reg::X6, Reg::X5, 8);
    ...
    c.li(Reg::X8, MASK_XLEN(0x4000));
    c.or_(Reg::X8, Reg::X8, Reg::X8);
    c.sw(Reg::X8, Reg::X5, 16);

    // rs1==x7, rs2==x9, rd==x12, rs2_val == -134217729, rs1_val == -8193
    // opcode: or ; op1:x7; op2:x9; dest:x12; op1val:-0x2001;  op2val:-0x8000001
    c.li(Reg::X7, MASK_XLEN(-0x2001));
    c.li(Reg::X9, MASK_XLEN(-0x8000001));
    c.or_(Reg::X12, Reg::X7, Reg::X9);
    c.sw(Reg::X12, Reg::X5, 20);
    ...
    c.or_(Reg::X1, Reg::X2, Reg::X12);
    c.sw(Reg::X1, Reg::X5, 8);

    // rs2==x4, rs2_val == -65537, 
    // opcode: or ; op1:x9; op2:x4; dest:x10; op1val:0x9;  op2val:-0x10001
    c.li(Reg::X9, MASK_XLEN(0x9));
    c.li(Reg::X4, MASK_XLEN(-0x10001));
    c.or_(Reg::X10, Reg::X9, Reg::X4);
    c.sw(Reg::X10, Reg::X5, 12);

    // rd==x4, rs2_val == -32769, 
    // opcode: or ; op1:x3; op2:x8; dest:x4; op1val:-0xb504;  op2val:-0x8001
    c.li(Reg::X3, MASK_XLEN(-0xb504));
    c.li(Reg::X8, MASK_XLEN(-0x8001));
    c.or_(Reg::X4, Reg::X3, Reg::X8);
