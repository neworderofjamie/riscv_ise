...
//----------------------------------------------------------------------------
std::vector<uint32_t> ArchTest::ori_01::generateCode(bool simulate)
{
    CodeGenerator c;
    ...
    c.li(Reg::X12, MASK_XLEN(0x200000));
    c.ori(Reg::X9, Reg::X12, SEXT_IMM(-0x800));
    ...
    c.ori(Reg::X0, Reg::X0, SEXT_IMM(0x3ff));
    ...
    c.li(Reg::X6, MASK_XLEN(-0x40000001));
    c.ori(Reg::X7, Reg::X6, SEXT_IMM(0x400));
    c.sw(Reg::X7, Reg::X1, 8);

    // rs1==x9, rd==x3, rs1_val == -536870913, 
    // opcode: ori ; op1:x9; dest:x3; op1val:-0x20000001;  immval:0x2d
    c.li(Reg::X9, MASK_XLEN(-0x20000001));
    c.ori(Reg::X3, Reg::X9, SEXT_IMM(0x2d));
    c.sw(Reg::X3, Reg::X1, 12);

    // rs1==x5, rd==x14, rs1_val == -268435457, 
    // opcode: ori ; op1:x5; dest:x14; op1val:-0x10000001;  immval:0x666
    c.li(Reg::X5, MASK_XLEN(-0x10000001));
    c.ori(Reg::X14, Reg::X5, SEXT_IMM(0x666));
    ...
    c.ori(Reg::X12, Reg::X11, SEXT_IMM(0x3));
    ...
    c.ori(Reg::X15, Reg::X10, SEXT_IMM(0x1));
    ...
    c.ori(Reg::X13, Reg::X4, SEXT_IMM(-0x555));
    c.sw(Reg::X13, Reg::X1, 36);

    c.li(Reg::X3, 60);
    // rs1==x15, rd==x10, rs1_val == -4194305, imm_val == -3
    // opcode: ori ; op1:x15; dest:x10; op1val:-0x400001;  immval:-0x3
    c.li(Reg::X15, MASK_XLEN(-0x400001));
    c.ori(Reg::X10, Reg::X15, SEXT_IMM(-0x3));
    c.sw(Reg::X10, Reg::X3, 0);
    ...
    c.ori(Reg::X11, Reg::X10, SEXT_IMM(-0x81));
    ...
    c.ori(Reg::X11, Reg::X10, SEXT_IMM(-0x401));
    ...
    c.ori(Reg::X11, Reg::X10, SEXT_IMM(-0x1));
