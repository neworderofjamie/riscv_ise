...
// ArchTest::slti_01
//----------------------------------------------------------------------------
const std::vector<uint32_t> &ArchTest::slti_01::getScalarInitData()
{
    return g_ScalarData;
}
//----------------------------------------------------------------------------
std::vector<uint32_t> ArchTest::slti_01::generateCode(bool simulate)
{
    CodeGenerator c;
    ...
    c.slti(Reg::X11, Reg::X3, SEXT_IMM(-0x800));
    ...
    c.slti(Reg::X7, Reg::X7, SEXT_IMM(0x665));
    c.sw(Reg::X7, Reg::X4, 4);
    ...
    c.slti(Reg::X10, Reg::X15, SEXT_IMM(-0x201));
    ...
    c.li(Reg::X6, MASK_XLEN(-0x8000001));
    c.slti(Reg::X5, Reg::X6, SEXT_IMM(0x2));
    ...
    c.slti(Reg::X2, Reg::X1, SEXT_IMM(0x665));
    c.sw(Reg::X2, Reg::X3, 12);
    ...
    c.slti(Reg::X8, Reg::X14, SEXT_IMM(0x4));
    c.sw(Reg::X8, Reg::X3, 16);
    ...
    c.slti(Reg::X15, Reg::X11, SEXT_IMM(0x4));
    ...
    c.slti(Reg::X11, Reg::X10, SEXT_IMM(0x20));
    ...
    c.slti(Reg::X11, Reg::X10, SEXT_IMM(-0x401));
    ...
    c.slti(Reg::X11, Reg::X10, SEXT_IMM(0x3ff));
    ...
    c.slti(Reg::X11, Reg::X10, SEXT_IMM(-0xa));
    ...
    c.slti(Reg::X11, Reg::X10, SEXT_IMM(-0x81));
    ...
    c.slti(Reg::X11, Reg::X10, SEXT_IMM(-0x21));
