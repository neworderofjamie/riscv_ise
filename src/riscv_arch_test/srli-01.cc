...
//----------------------------------------------------------------------------
std::vector<uint32_t> ArchTest::srli_01::generateCode(bool simulate)
{
    CodeGenerator c;
    ...
    c.li(Reg::X4, MASK_XLEN(-0x41));
    c.srli(Reg::X5, Reg::X4, SEXT_IMM(0x1f));
    c.sw(Reg::X5, Reg::X1, 0);
    ...
    c.srli(Reg::X9, Reg::X9, SEXT_IMM(0x8));
    ...
    c.srli(Reg::X3, Reg::X7, SEXT_IMM(0x2));
    ...
    c.srli(Reg::X2, Reg::X6, SEXT_IMM(0x12));
    ...
    c.srli(Reg::X15, Reg::X11, SEXT_IMM(0x10));
    ...
    c.srli(Reg::X11, Reg::X10, SEXT_IMM(0x11));
