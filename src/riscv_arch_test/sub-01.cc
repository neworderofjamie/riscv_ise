...
//----------------------------------------------------------------------------
std::vector<uint32_t> ArchTest::sub_01::generateCode(bool simulate)
{
    CodeGenerator c;
    ...
    c.li(Reg::X9, MASK_XLEN(0x400000));
    c.sub(Reg::X4, Reg::X14, Reg::X9);
    c.sw(Reg::X4, Reg::X3, 0);
    ...
    c.li(Reg::X1, MASK_XLEN(-0x400001));
    c.li(Reg::X0, MASK_XLEN(0x0));
    c.sub(Reg::X1, Reg::X1, Reg::X0);
    ...
    c.li(Reg::X12, MASK_XLEN(-0x800001));
    c.li(Reg::X12, MASK_XLEN(-0x800001));
    c.sub(Reg::X15, Reg::X12, Reg::X12);
    ...
    c.li(Reg::X8, MASK_XLEN(0x10));
    c.li(Reg::X3, MASK_XLEN(-0x1000001));
    ...
    c.li(Reg::X15, MASK_XLEN(0x2));
    c.li(Reg::X4, MASK_XLEN(-0x400001));
    c.sub(Reg::X2, Reg::X15, Reg::X4);
    c.sw(Reg::X2, Reg::X1, 12);
    ...
    c.li(Reg::X6, MASK_XLEN(-0x201));
    c.li(Reg::X7, MASK_XLEN(-0x100001));
    c.sub(Reg::X3, Reg::X6, Reg::X7);
