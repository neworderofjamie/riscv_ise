...
// ArchTest::xor_01
//----------------------------------------------------------------------------
const std::vector<uint32_t> &ArchTest::xor_01::getScalarInitData()
{
    return g_ScalarData;
}
//----------------------------------------------------------------------------
std::vector<uint32_t> ArchTest::xor_01::generateCode(bool simulate)
{
    CodeGenerator c;
    ...
    c.li(Reg::X5, MASK_XLEN(0x20000));
    c.li(Reg::X14, MASK_XLEN(-0x100001));
    c.xor_(Reg::X1, Reg::X5, Reg::X14);
    c.sw(Reg::X1, Reg::X7, 0);
    ...
    c.li(Reg::X15, MASK_XLEN(0x7fffffff));
    c.xor_(Reg::X3, Reg::X3, Reg::X15);
    c.sw(Reg::X3, Reg::X7, 4);

    // rs2 == rd != rs1, rs1==x4, rs2==x0, rd==x0, rs2_val == -1073741825, rs1_val == 1024
    // opcode: xor ; op1:x4; op2:x0; dest:x0; op1val:0x400;  op2val:0x0
    c.li(Reg::X4, MASK_XLEN(0x400));
    c.li(Reg::X0, MASK_XLEN(0x0));
    c.xor_(Reg::X0, Reg::X4, Reg::X0);
    c.sw(Reg::X0, Reg::X7, 8);
    ...
    c.li(Reg::X8, MASK_XLEN(0x2000));
    c.xor_(Reg::X6, Reg::X8, Reg::X8);
    c.sw(Reg::X6, Reg::X7, 12);
    ...
    c.li(Reg::X12, MASK_XLEN(0x1));
    c.xor_(Reg::X12, Reg::X12, Reg::X12);
    ...
    c.li(Reg::X1, MASK_XLEN(0x66666667));
    c.li(Reg::X4, MASK_XLEN(-0x8000001));
    c.xor_(Reg::X15, Reg::X1, Reg::X4);
    c.sw(Reg::X15, Reg::X7, 20);
    ...
    c.li(Reg::X1, MASK_XLEN(-0x4000001));
    c.xor_(Reg::X14, Reg::X9, Reg::X1);
    c.sw(Reg::X14, Reg::X7, 24);

    // rs1==x15, rs2==x13, rd==x2, rs2_val == -33554433, rs1_val == 32768
    // opcode: xor ; op1:x15; op2:x13; dest:x2; op1val:0x8000;  op2val:-0x2000001
    c.li(Reg::X15, MASK_XLEN(0x8000));
    c.li(Reg::X13, MASK_XLEN(-0x2000001));
    c.xor_(Reg::X2, Reg::X15, Reg::X13);
    c.sw(Reg::X2, Reg::X7, 28);
    ...
    c.li(Reg::X9, MASK_XLEN(-0x1000001));
    c.xor_(Reg::X11, Reg::X10, Reg::X9);
    ...
    c.li(Reg::X7, MASK_XLEN(-0x11));
    c.li(Reg::X5, MASK_XLEN(-0x800001));
    c.xor_(Reg::X10, Reg::X7, Reg::X5);
    ...
    c.li(Reg::X6, MASK_XLEN(0x40000));
    c.li(Reg::X7, MASK_XLEN(-0x400001));
    c.xor_(Reg::X8, Reg::X6, Reg::X7);
    ...
    c.li(Reg::X6, MASK_XLEN(-0x80001));
    c.xor_(Reg::X9, Reg::X14, Reg::X6);
    c.sw(Reg::X9, Reg::X1, 16);

    // rs1==x0, rs2==x3, rd==x7, rs2_val == -262145, rs1_val == -65537
    // opcode: xor ; op1:x0; op2:x3; dest:x7; op1val:0x0;  op2val:-0x40001
    c.li(Reg::X0, MASK_XLEN(0x0));
    c.li(Reg::X3, MASK_XLEN(-0x40001));
    c.xor_(Reg::X7, Reg::X0, Reg::X3);
    c.sw(Reg::X7, Reg::X1, 20);
    ...
    c.xor_(Reg::X5, Reg::X11, Reg::X10);
    c.sw(Reg::X5, Reg::X1, 24);

    // rs1==x2, rs2_val == -65537, rs1_val == 2
    // opcode: xor ; op1:x2; op2:x9; dest:x14; op1val:0x2;  op2val:-0x10001
    c.li(Reg::X2, MASK_XLEN(0x2));
    c.li(Reg::X9, MASK_XLEN(-0x10001));
    c.xor_(Reg::X14, Reg::X2, Reg::X9);
    c.sw(Reg::X14, Reg::X1, 28);
    ...
    c.li(Reg::X2, MASK_XLEN(-0x8001));
    c.xor_(Reg::X14, Reg::X10, Reg::X2);
