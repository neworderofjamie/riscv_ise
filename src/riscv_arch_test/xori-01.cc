...
//----------------------------------------------------------------------------
std::vector<uint32_t> ArchTest::xori_01::generateCode(bool simulate)
{
    CodeGenerator c;
    ...
    c.xori(Reg::X13, Reg::X12, SEXT_IMM(-0x800));
    c.sw(Reg::X13, Reg::X1, 0);
    ...
    c.xori(Reg::X10, Reg::X10, SEXT_IMM(-0x556));
    c.sw(Reg::X10, Reg::X1, 4);
    ...
    c.xori(Reg::X4, Reg::X8, SEXT_IMM(-0x101));
    ...
    c.li(Reg::X6, MASK_XLEN(-0x20000001));
    c.xori(Reg::X7, Reg::X6, SEXT_IMM(0x2));
    c.sw(Reg::X7, Reg::X1, 12);

    // rs1==x9, rd==x14, rs1_val == -268435457, 
    // opcode: xori ; op1:x9; dest:x14; op1val:-0x10000001;  immval:0x6
    c.li(Reg::X9, MASK_XLEN(-0x10000001));
    c.xori(Reg::X14, Reg::X9, SEXT_IMM(0x6));
    ...
    c.xori(Reg::X3, Reg::X7, SEXT_IMM(-0x2c));
    c.sw(Reg::X3, Reg::X1, 20);
    ...
    c.xori(Reg::X11, Reg::X10, SEXT_IMM(-0x401));
    ...
    c.xori(Reg::X11, Reg::X10, SEXT_IMM(0x3ff));
    ...
    c.xori(Reg::X11, Reg::X10, SEXT_IMM(0x7));
    ...
    c.li(Reg::X10, MASK_XLEN(0x1));
    c.xori(Reg::X11, Reg::X10, SEXT_IMM(0x20));
