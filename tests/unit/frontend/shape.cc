...
TEST(Shape, Split)
{
    // 1D
    {
        ...
        {
            const auto split0 = shape.split(0, 0, 2, 1);
            const auto split1 = shape.split(1, 0, 2, 1);
        ...
        {
            const auto split0 = shape.split(0, 0, 2, 32);
            const auto split1 = shape.split(1, 0, 2, 32);
    ...
    // 2D lowest dimension
    {
        ...
        // Splitting two ways without granularity
        {
            const auto split0 = shape.split(0, 1, 2, 1);
            const auto split1 = shape.split(1, 1, 2, 1);
        ...
        // Splitting two ways with granularity 32
        {
            const auto split0 = shape.split(0, 1, 2, 32);
            const auto split1 = shape.split(1, 1, 2, 32);
